/**
 * Nightly e-Gazette crawl.
 *
 *     pnpm --filter @ap-emp-ai/ingest scrape:gazette [days]
 *
...
import { scrapeGazette } from "../gazette/scrape.js";
...
const summary = await scrapeGazette({
  config,
  queue: new IngestQueue(db, "e-gazette"),
  days,
